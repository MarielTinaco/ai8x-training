...
class AI85EQUINE(nn.Module):
    ...
    def __init__(
        ...
        self.fc4 = ai8x.Linear(512, 256, bias=bias, wide=True, **kwargs)
        # T : 2 F: 128
        self.fc = ai8x.Linear(256, 37, bias=bias, wide=True, **kwargs)
...
def ai85equine(pretrained=False, **kwargs):
    """
    Constructs a AI85KWS20Net model.
    rn AI85KWS20Net(**kwargs)
    """
    assert not pretrained
    return AI85EQUINE(**kwargs)
